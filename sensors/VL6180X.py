...
class VL6180X:
    ...
    def set_address(self, new_address: int, _I2C_SLAVE_DEVICE_ADDRESS=0x212) -> None:
        ...
        """
        self._write_8(_I2C_SLAVE_DEVICE_ADDRESS, new_address & 0x7F)
        self._device = i2c_device.I2CDevice(self._device.i2c, new_address)
